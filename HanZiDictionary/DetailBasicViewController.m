...
- (void)viewDidLoad
{
    ...
    //===================================================================================================
    self.titleLabel=[[[UILabel alloc]initWithFrame:CGRectMake(10-2, 48, 60, 61)]autorelease];
    ...
    //这里的笔顺label是写死的，因为当写龘（da）字的时候容易出问题，而自动调整大小就必须调整下面的基本信息、汉语字典、组词成语、和英文翻译等选项，为了一个生僻字这样做感觉不值得，而且也不会！先这样写吧。
      self.biShunLab=[[UILabel alloc]initWithFrame:CGRectMake(10, 108, 320-10, 45)];
    ...
    self.biShunLab.lineBreakMode=NSLineBreakByWordWrapping;
    self.biShunLab.numberOfLines=0;
    self.biShunLab.textAlignment=NSTextAlignmentLeft;
    [self.view addSubview:self.biShunLab];
    //********************************************

    self.zhuYinLab=[[[UILabel alloc]initWithFrame:CGRectMake(180-15, 50, 80, 15)]autorelease];
    ...
    self.jieGouLab=[[[UILabel alloc]initWithFrame:CGRectMake(180-15, 70, 320-180-10, 15)]autorelease];
    ...
    self.buShouBiHuaLab=[[[UILabel alloc]initWithFrame:CGRectMake(180-15, 90, 80, 15)]autorelease];
    ...
    self.biHuaLab=[[[UILabel alloc]initWithFrame:CGRectMake(260-15, 90, 90, 15)]autorelease];
    ...
    self.zhuYinButton.frame=CGRectMake(240, 48, 25, 23);
    [self.view addSubview:self.zhuYinButton];
        
    self.jiBenXinXi=[[[UIButton alloc]initWithFrame:CGRectMake(10, 150, 75, 33)]autorelease];
    ...
    self.hanYuZiDian=[[[UIButton alloc]initWithFrame:CGRectMake(10+74, 150, 75, 33)]autorelease];
    ...
    self.zuCiChengYu=[[[UIButton alloc]initWithFrame:CGRectMake(84+74, 150, 75, 33)]autorelease];
    ...
    self.yingWenFanYi=[[[UIButton alloc]initWithFrame:CGRectMake(84+74+74, 150, 75, 33)]autorelease];
    ...
    //===================================================================================================
    self.jiBenView =[[[UIView alloc]initWithFrame:CGRectMake(2,195, 316, 291)]autorelease];
...
-(void)backMainView:(id)sender{
    [self.act stopAnimating];//在返回的时候停止进度轮动画，其实这种方法并不好，因为把停止的动作放在了一个button上而不是资源展示完毕的时候
